...
subtitle: (İktisatçılar İçin) Makine Öğrenmesi
...
- Beklenen test hatasının azaltılabilmemsi için eşanlı olarak hem düşük varyanslı hem de düşük sapmalı öğrenme yönteminin seçilmesi gerekir. 
...
.center[![:scale 82%](img/MSE2.PNG)]

Dikey kesikli çizgi: en küçük test MSE değerini veren karmaşıklık düzeyi (serbestlik derecesi - degrees of freedom)

(Kaynak: James et al., Figure 2.12, s.36)
...
.center[![:scale 70%](img/KNN4.PNG)]

Not: Kesikli siyah çizgi Bayes hata oranıdır (veriler simülasyonla üretildiği için biliniyor)

(Kaynak: James et al., Figure 2.17, s.42)
